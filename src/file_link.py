...
boss_cover_image = pg.image.load("../image/background/boss_cover.png")
skill_interface_image = pg.image.load("../image/background/skill_interface.png")
...
boss_eyes_image = pg.image.load("../image/enemy/boss_eyes.png")
